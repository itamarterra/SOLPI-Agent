...
def _hermes_home_path() -> Path:
    ...
    try:
        from solpi_engine_constants import get_hermes_home  # local import to avoid cycles
...
def _hermes_root_path() -> Path:
    ...
    try:
        from solpi_engine_constants import get_default_hermes_root  # local import to avoid cycles
