...
class TestGetSubprocessHome:
    """Unit tests for solpi_engine_constants.get_subprocess_home()."""

    def _host_mode(self, monkeypatch):
        monkeypatch.setattr(solpi_engine_constants, "is_container", lambda: False)
    ...
    def test_returns_none_when_hermes_home_unset(self, monkeypatch):
        ...
        from solpi_engine_constants import get_subprocess_home
    ...
    def test_real_mode_repairs_parent_home_already_pointing_at_profile(self, tmp_path, monkeypatch):
        ...
        from solpi_engine_constants import get_subprocess_home, get_real_home
    ...
    def test_real_home_falls_back_to_os_account_when_home_is_profile(self, tmp_path, monkeypatch):
        ...
        from solpi_engine_constants import get_real_home
