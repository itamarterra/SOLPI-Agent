...
log lines comes from a SEPARATE mechanism — ``solpi_engine_logging._session_context``
...
def test_logging_session_context_follows_compression_rotation(tmp_path: Path) -> None:
    ...
    solpi_engine_logging.set_session_context(parent_sid)
    try:
        ...
        current = getattr(solpi_engine_logging._session_context, "session_id", None)
