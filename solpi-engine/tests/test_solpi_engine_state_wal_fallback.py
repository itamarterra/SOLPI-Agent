...
def _reset_last_init_error():
    ...
    solpi_engine_state._set_last_init_error(None)
    yield
    solpi_engine_state._set_last_init_error(None)
...
def _reset_wal_fallback_warned_paths():
    ...
    solpi_engine_state._wal_fallback_warned_paths.clear()
    yield
    solpi_engine_state._wal_fallback_warned_paths.clear()
...
class TestApplyWalWithFallback:
    ...
    def test_falls_back_to_delete_on_locking_protocol(self, tmp_path, caplog):
        ...
        with caplog.at_level("WARNING", logger="solpi_engine_state"):
...
class TestGetLastInitError:
    ...
    def test_success_does_not_clear_prior_error(self, tmp_path):
        ...
        """
        solpi_engine_state._set_last_init_error("OperationalError: locking protocol")
    ...
    def test_captures_cause_on_failed_init(self, tmp_path):
        ...
        with patch("solpi_engine_state.sqlite3.connect", side_effect=gated_connect):
...
class TestFormatSessionDbUnavailable:
    ...
    def test_includes_cause(self):
        ...
        solpi_engine_state._set_last_init_error("OperationalError: generic SQLite error")
