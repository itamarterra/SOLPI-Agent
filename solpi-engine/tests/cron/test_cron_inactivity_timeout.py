...
class TestSysPathOrdering:
    ...
    def test_solpi_engine_time_importable(self):
        """solpi_engine_time should be importable when cron.scheduler loads."""
    ...
    def test_solpi_engine_constants_importable(self):
        """solpi_engine_constants should be importable from cron context."""
