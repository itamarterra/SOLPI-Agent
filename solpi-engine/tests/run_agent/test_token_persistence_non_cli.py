...
def test_session_search_lazily_opens_db_when_entrypoint_did_not_pass_one(monkeypatch):
    ...
    solpi_engine_state = ModuleType("solpi_engine_state")
    solpi_engine_state.SessionDB = FakeSessionDB
    monkeypatch.setitem(sys.modules, "solpi_engine_state", solpi_engine_state)
