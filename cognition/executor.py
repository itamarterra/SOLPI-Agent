...
class Executor:
    ...
    Atua como a ponte de despacho para microsserviços agênticos.
    """
    def __init__(self, memory, registry=None):
        self.memory = memory
        self.registry = registry
        self.active_agents = {}
        self._lock = threading.Lock() # Garante thread-safety na instanciação
    ...
    def _get_agent(self, agent_name):
        """Carrega e instancia o agente com proteção de thread-safety."""
        with self._lock:
